describe 'Jaccard' do
  context 'Index' do
    ...
    it 'accepts two arguments' do
      expect { Measurable.jaccard_index(@u, @v) }.not_to raise_error
    ...
    it 'works with vectors of different length' do
      expect { Measurable.jaccard_index(@u, [1, 2, 3, 4]) }.not_to raise_error
    end
  ...
  context 'Distance' do
    ...
    it 'accepts two arguments' do
      expect { Measurable.jaccard_dissimilarity(@u, @v) }.not_to raise_error
    ...
    it 'works with vectors of different length' do
      expect { Measurable.jaccard_dissimilarity(@u, [1, 2, 3, 4]) }.not_to raise_error
    end
  end
end
